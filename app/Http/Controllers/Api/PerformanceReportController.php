...
class PerformanceReportController extends Controller
{
    ...
    {
        if ($percentage >= 80) {
            return "You have a solid understanding of $topicName. Keep it up!";
        }
        if ($percentage >= 60) {
            return "Good job on $topicName. A bit more practice will make you an expert.";
        }
        if ($percentage >= 40) {
            return "Consider reviewing the core concepts of $topicName and trying more practice questions.";
        }
