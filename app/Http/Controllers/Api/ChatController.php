...
class ChatController extends Controller
{
    ...
    {
        // Security: Validate message input and restrict attachment file types/sizes to prevent arbitrary file upload vulnerabilities
        $request->validate([
            'content' => 'required|string',
            'recipient_id' => 'nullable|integer',
            'group_id' => 'nullable|integer',
            'attachments' => 'nullable|array',
            'attachments.*' => 'file|mimes:jpeg,png,jpg,gif,webp,pdf,doc,docx,txt,mp3,wav,mp4,webm,zip|max:10240',
        ]);
