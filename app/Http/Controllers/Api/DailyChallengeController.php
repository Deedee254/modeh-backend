...
class DailyChallengeController extends Controller
{
    ...
    public function today(Request $request)
    {
        ...
        try {
            ...
            // Log internal error without exposing internal exception details or stack traces
            \Log::error('Error fetching daily challenge: '.$e->getMessage());

            return response()->json(['error' => 'An error occurred while fetching the daily challenge.'], 500);
        }
    }
